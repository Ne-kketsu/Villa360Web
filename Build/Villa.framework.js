...
var ASM_CONSTS = {
  7969232: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 7969287: ($0) => { performance.now = function() { return $0; }; },  
 7969335: ($0) => { performance.now = function() { return $0; }; },  
 7969383: () => { performance.now = Module['emscripten_get_now_backup']; }
};
